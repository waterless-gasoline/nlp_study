...
# 加载和预处理数据
dataset_df = pd.read_csv("toutiao_cat_data.csv", header=None)
...
# 从预训练模型加载分词器和模型
tokenizer = BertTokenizer.from_pretrained(r'D:\pycharm\NLP\NLP\宋老师\2.NLP\3.语言模型\bert-base-chinese')
model = BertForSequenceClassification.from_pretrained(r'D:\pycharm\NLP\NLP\宋老师\2.NLP\3.语言模型\bert-base-chinese', num_labels=17)
