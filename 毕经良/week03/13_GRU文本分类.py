...
class CharGRUDataset(Dataset):
    ...
    def __init__(self, texts, labels, char_to_index, max_len):
        ...
        self.char_to_index = char_to_index # 字符到索引的映射关系 a:2 我：5
...
class GRUClassifier(nn.Module):
    ...
    def forward(self, x):
        ...
        # GRU 返回 output, hidden_state (不返回cell_state)
...
"""
- __GRU__（门控循环单元）：只有2个门（重置门和更新门），没有单独的cell state，参数更少，训练更快

- __LSTM__（长短期记忆网络）：有3个门（输入门、遗忘门、输出门），维护独立的cell state，表达能力更强但计算开销更大

Epoch [3/4], Loss: 0.3230
Batch 个数 0, 当前Batch Loss: 0.1684420257806778
Batch 个数 50, 当前Batch Loss: 0.1216781735420227
Batch 个数 100, 当前Batch Loss: 0.25552234053611755
Batch 个数 150, 当前Batch Loss: 0.1811535656452179
Batch 个数 200, 当前Batch Loss: 0.13678425550460815
Batch 个数 250, 当前Batch Loss: 0.26113083958625793
Batch 个数 300, 当前Batch Loss: 0.0882510393857956
Batch 个数 350, 当前Batch Loss: 0.2078831046819687
Epoch [4/4], Loss: 0.2349
