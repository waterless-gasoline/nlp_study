...
while True:
    hidden_dim = int(input("请输入隐藏层维度(默认128)：") or 128)
    ...
    num_epochs = int(input("请输入训练轮数(默认10)：") or 10)
    ...
    print(f"当前隐藏层维度为 {hidden_dim},当前训练轮数为 {num_epochs}, Loss: {running_loss / len(dataloader):.4f}")
