...
# 加载和预处理数据
dataset_df = pd.read_csv('./datasets/book_type_new.csv', sep=',', header=None)
...
# 从预训练模型加载分词器和模型
tokenizer = BertTokenizer.from_pretrained('/Users/foubaby/models/google-bert/bert-base-chinese')
model = BertForSequenceClassification.from_pretrained(
    '/Users/foubaby/models/google-bert/bert-base-chinese', num_labels=5 # 判别式模型，分多少类
)
...
training_args = TrainingArguments(
    output_dir='./weights/bert/', # 训练输出目录，用于保存模型和状态
