...
tokenizer = AutoTokenizer.from_pretrained("/Users/foubaby/models/google-bert/bert-base-chinese/")
model = BertForSequenceClassification.from_pretrained("/Users/foubaby/models/google-bert/bert-base-chinese/", num_labels=5)
...
def model_for_bert(request_text: Union[str, List[str]]) -> Union[str, List[str]]:
    CATEGORY_NAME = ['社会科学综合性论文集', '统计学', '谱系学、姓氏与族谱研究', '自然科学科普读物', '生物化学']
