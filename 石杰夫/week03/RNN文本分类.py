...
dataset_path = r"e:\AI\NLP\第1周：课程介绍与大模型基础\Week01\dataset.csv"

# Load dataset
try:
    dataset = pd.read_csv(dataset_path, sep="\t", header=None)
except FileNotFoundError:
    print(f"Warning: Dataset not found at {dataset_path}. Trying relative path...")
...
class RNNClassifier(nn.Module):
    def __init__(self, vocab_size, embedding_dim, hidden_dim, output_dim):
        ...
        self.rnn = nn.RNN(embedding_dim, hidden_dim, batch_first=True, nonlinearity='relu')  # RNN 循环层
